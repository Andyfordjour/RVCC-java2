...
/**
 * This class throws an IllegalArgumentException when an empty string is passed
 * as a description, or 0 is passed as the number of units.
 *
...
public class InventoryItem {
    ...
    public InventoryItem(String d) {
        if (d.equals("")) {
            throw new IllegalArgumentException("001: Description "
                    + "is an empty string.");
        }
    ...
    public InventoryItem(String d, int u) {
        if (d.equals("")) {
            throw new IllegalArgumentException("002: Description "
                    + "is an empty string.");
        }
        if (u < 0) {
            throw new IllegalArgumentException("003: Units is negative.");
        }
    ...
    public void setDescription(String d) {
        if (d.equals("")) {
            throw new IllegalArgumentException("004: Description "
                    + " is an empty string.");
        }
    ...
    public void setUnits(int u) {
        if (u < 0) {
            throw new IllegalArgumentException("005: Units is 0.");
        }
