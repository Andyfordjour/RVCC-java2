...
/**
 * This program uses the RandomAccessFile class to open the file Letters.dat and
 * randomly read letters from different locations.
 */
public class ReadRandomLetters {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            System.out.println("Letters.DAT file not found - run WriteLetters first");
        }
    }
}
